...
public class SwaggerUtils {
    private static final String url = "http://127.0.0.1:8087/v2/api-docs";
    /**
     * 生成AsciiDocs格式文档
    ...
    public static void generateConfluenceDocs() throws MalformedURLException {
        ...
        Swagger2MarkupConverter.from(new URL(url))
                .withConfig(config)
                .build()
                .toFolder(Paths.get("src/main/resources/docs/confluence/generated"));
    }
    ...
    public static void generateConfluenceDocsToFile() throws MalformedURLException {
        ...
        Swagger2MarkupConverter.from(new URL(url))
                .withConfig(config)
                .build()
                .toFile(Paths.get("src/main/resources/docs/confluence/generated/all"));
    }
}
